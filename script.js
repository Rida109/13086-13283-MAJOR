document.getElementById("loginForm").addEventListener("submit", function (event) {
    ...
    if (username === "ADMIN" && password === "1234") {
        ...
        document.getElementById("tools-board").style.display = "block";
        document.getElementById("drawing-board").style.display = "flex";
        document.getElementById("drawing-board").style.backgroundColor = "white";
        document.getElementById("drawing-board").style.borderRadius = "10px";
        ...
        startDrawing(); // Initialize drawing functionality
    } else {
